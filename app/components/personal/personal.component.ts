...
export class PersonalComponent implements OnInit {
    ...
    ngOnInit(): void {
		...
		for (let i = 0; i < length; i++) {
			this.countryListAux[i] = this.countryObj[i].name;
			this.countryEmoji[i] = this.countryObj[i].emoji;
		}
	...
	itemTapped(args) {
		if (this.listPickerState == 0) {
			this.country = args.selectedItem;
			this.emoji = this.countryEmoji[this.countryList.indexOf(this.country)];
		} else if (this.listPickerState == 1) {
			this.state = args.selectedItem;
		}
	}
	
	showPicker() {
		this.listPickerState = 0;
		this.countryList = this.countryListAux;
		this.myfilter.nativeElement.show();
	}

	showPickerStates() {
		this.listPickerState = 1;
		this.countryList = this.statesUs;
		this.myfilter.nativeElement.show();
	}
